...
insert into products(name, quantity, price, supplier_id) values ('Name1', 1, 100, 1);
insert into products(name, quantity, price, supplier_id) values ('Name2', 2, 200, 1);
insert into products(name, quantity, price, supplier_id) values ('Name3', 3, 300, 2);
